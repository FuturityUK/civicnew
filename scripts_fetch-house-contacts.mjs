...
function computeRole(state) {
  ...
  if (NON_VOTING_STATES.has(state)) return 'Delegate';
...
function toMemberRecord(l, socialByBio, officesByBio) {
  ...
  const record = {
    ...
    contact: {
      capitol_office: {
        office: term?.office ?? null, // e.g., "1229 Longworth House Office Building"
...
function compareMembers(a, b) {
  // Sort by state, then numeric district (nulls last), then last name
